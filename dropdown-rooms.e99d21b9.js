...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"components/dropdown-rooms/dropdown-rooms.js":[function(require,module,exports) {
jQuery(function ($) {
  var bedrooms = 0;
  var beds = 0;
  var bathrooms = 0;
  $(".dropdown-rooms").on('click', function () {
    ...
    $(this).find(".quantity-buttons__button").on('click', function () {
      var value = bedrooms + wordDeclension(bedrooms, [" спальня", " спальни", " спален"]) + ", " + beds + wordDeclension(beds, [" кровать", " кровати", "  кроватей"]) + ", " + bathrooms + wordDeclension(bathrooms, [" ванна", " ванны", "  ванных"]);
  ...
  $(".dropdown-rooms__button").on('click', function () {
    ...
    $(this).toggleClass("dropdown-rooms__button-visible"); // return bedrooms = 0, beds = 0, bathrooms = 0;
  });
});
...
},{}]},{},["../../../Users/Jaguar/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","components/dropdown-rooms/dropdown-rooms.js"], null)
//# sourceMappingURL=/dist/dropdown-rooms.e99d21b9.js.map